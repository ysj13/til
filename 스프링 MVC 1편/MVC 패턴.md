...
그런데 이렇게 변경해도 해결되지 않는 몇가지 문제점이 남아있다. JAVA 코드, 데이터를 조회하는 리포지토리 등등 다양한 코드가 모두 JSP에 작성되어 있기 때문에 JSP가 너무 많은 역할을 하게된다.
...
![FrontController](https://github.com/ysj13/til/assets/59955248/342afc4c-1095-41ee-add0-14fa79095953)
